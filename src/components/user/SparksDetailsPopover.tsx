...
export default function SparksDetailsPopover({
  userProfile,
  sparksBalance,
  claimDetails,
  countdown,
  ...
  claiming,
  onClose,
}: SparksDetailsPopoverProps) {
  const dailyReward = userProfile.is_verified ? 10000 : 5000;
